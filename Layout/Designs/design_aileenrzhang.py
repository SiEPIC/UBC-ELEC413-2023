...
def design_aileenrzhang(cell, cell_y, inst_wg1, inst_wg2, inst_wg3, waveguide_type):
    ...
    try:
        connect_pins_with_waveguide(inst_bragg1, 'opt2', inst_bragg2, 'opt2', 
            ...
            turtle_A = [250,90,20,90,250,-90,20,-90,250,90,20,90,250,-90,20,-90, 250,90,20,90,84,-90,20,-90] )

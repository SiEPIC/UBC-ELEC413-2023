...
def design_kithminrw(cell, cell_y, inst_wg1, inst_wg2, inst_wg3, waveguide_type):
    ...
    inst_taper2.transform(Trans(215000,0))
    ...
    inst_taper3.transform(Trans(215000,20000))
    ...
    # move the taper to the right and up
    inst_taper6.transform(Trans(190000,0))

...
def design_moritzs(cell, cell_y, inst_wg1, inst_wg2, inst_wg3, waveguide_type):
    ...
    cell_bragg = ly.create_cell('Bragg_grating', library, {
        ...
        'wg_width': 0.385,
        'sinusoidal': False})
    cell_bragg2 = ly.create_cell('Bragg_grating', library, {
    ...
    inst_bragg2 = connect_cell(inst_bragg1, 'opt2', cell_bragg2, 'opt2')
